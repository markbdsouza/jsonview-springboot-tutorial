...
In Level 3, we will use the H2 Database to pick data from & directly use the `@JsonView` on the Entity itself.
This helps us eliminate the use of any DTO, RequestModel, ResponseModel.
...
[
   ...
   ```
#### Endpoint 2: GET from DB with PublicView   
...
```
 [
   ...
   ```
#### Endpoint 3: GET from DB without CustomerDetailsView
